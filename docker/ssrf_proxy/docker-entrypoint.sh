...
if [ -n "${SSRF_SANDBOX_PROXY_PORT:-}" ]; then
    ...
    {
        printf 'http_port %s accel defaultsite=%s\n' "$SSRF_SANDBOX_PROXY_PORT" "$sandbox_proxy_host"
        ...
        printf 'cache_peer_access dify_sandbox allow dify_sandbox_proxy_port\n'
        printf 'never_direct allow dify_sandbox_proxy_port\n'
