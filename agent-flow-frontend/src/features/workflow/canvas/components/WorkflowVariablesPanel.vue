...
.variable-row { min-height:54px; padding:10px 8px; border-bottom:1px solid #f2f4f7; }.variable-main { display:flex; min-width:0; flex-wrap:wrap; align-items:center; gap:6px; }.variable-main code { color:#155eef; }.variable-main span { border-radius:4px; background:#f2f4f7; padding:2px 5px; color:#667085; font-size:10px; }.variable-main small { width:100%; overflow:hidden; color:#667085; text-overflow:ellipsis; white-space:nowrap; }.row-actions { display:flex; }.row-actions button:last-child { color:#d92d20; }.empty { padding:48px 0; text-align:center; color:#98a2b3; }
