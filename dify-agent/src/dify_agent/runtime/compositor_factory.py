...
- ``dify.knowledge_base`` for inner-API-backed knowledge search tools, and
- ``dify.input`` for multimodal vision image URLs on the user turn.
...
def create_default_layer_providers(
    *,
    ...
    return (
        ...
        LayerProvider.from_layer_type(DifyInputLayer),
