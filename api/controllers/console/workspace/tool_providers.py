...
class ToolProviderMCPApi(Resource):
    ...
    def post(self, tenant_id: str, user: Account):
        ...
        # A provider only exists after a real MCP handshake. Authentication
        # challenges are represented by ``authed=False`` and are still a valid
        # preflight result; protocol, timeout and transport failures abort here.
        connection_result = MCPToolManageService.reconnect_with_url(
        ...
        # Persist the encrypted connection only after the network preflight.
