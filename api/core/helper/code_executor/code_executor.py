...
def _build_code_executor_client() -> httpx.Client:
    # Sandbox is an internal endpoint (compose DNS or 127.0.0.1). If httpx honors
    # OS/HTTP proxies, Windows clients send the request to Clash/VPN instead,
    # which surfaces as HTTP 502.
    return httpx.Client(
