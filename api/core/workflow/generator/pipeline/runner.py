...
from core.workflow.generator.compiler.node_builder import build_graph as build_node_graph
...
from core.workflow.generator.pipeline.planner import iter_plan
from core.workflow.generator.pipeline.planner_context_values import PlannerContextCheckpoint, PlannerContextLimitError
...
from core.workflow.generator.pipeline.planning_types import PlannerRequirementInvalidError
from core.workflow.generator.prompts.output_language import (
    detect_output_language,
    localized_generator_message,
)
from core.workflow.generator.resources.knowledge_catalogue import KnowledgeCatalogueEntry, format_knowledge_catalogue
...
class WorkflowGenerator:
    ...
    def _iter_generation_events(
        ...
        *,
        ...
        tool_parameter_names, tool_output_names = tool_schema_lookups(tool_catalogue_entries)
