...
from core.workflow.generator.planning_session import PlanningSessionState, VerifiedResourceSnapshot
...
class PlanningActionPolicy:
    ...
    def _evaluate_plan_resources(
        ...
        bound_tool_ids = {
            binding["resource_id"] for binding in valid_bindings if binding["resource_kind"] == "tool"
        }
