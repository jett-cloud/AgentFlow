...
Incomplete JSON is dropped, never executed.
"""
...
from core.workflow.generator.llm_response import extract_chunk_text_delta
...
def assemble_stream_turn(
    ...
    *,
    ...
    if blocking_result is not None:
        ...
        return events, assembler.finish()
